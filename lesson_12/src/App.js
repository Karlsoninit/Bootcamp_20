...
import configAction from "./redux/config/configActions";
import { uploadTasks } from "./redux/session/sessionActions";
import TaskList from "./components/taskList/TaskList";

// configSlise

import { configSlice } from "../src/redux/config/configReducer";
...
export default connect(null, { ...configSlice.actions })(App);
